...
public abstract class AbstractMqttSourceTest extends SimpleTestInClusterSupport {
    ...
    public void setup() throws MqttException {
        ...
        broker = getContainter().connectionString();
        client = createClient();
    ...
    public void test_autoReconnect() throws MqttException {
        ...
        MqttSourceBuilder<byte[]> builder = MqttSources.builder()
                ...
                .autoReconnect();
        additionalOptionsForSource(builder);
    ...
    private MqttClient createClient() throws MqttException {
        ...
        additionalOptionsForClient(options);
    ...
    public abstract MosquittoContainer getContainter();
